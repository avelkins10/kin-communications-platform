...
export default defineConfig({
  ...
  reporter: [
    ['html', { outputFolder: 'playwright-preview-report' }],
    ['json', { outputFile: 'test-results/preview-results.json' }],
    ['junit', { outputFile: 'test-results/preview-results.xml' }],
  ...
  use: {
    ...
    baseURL: process.env.BASE_URL || 'https://preview-url.vercel.app',
    ...
    /* Ignore HTTPS errors for preview environments */
    ignoreHTTPSErrors: true,
    
    /* Set user agent */
    userAgent: 'Mozilla/5.0 (compatible; Playwright Preview Tests)',
